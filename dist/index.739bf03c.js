...
},{"./app":"8lRBv","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8lRBv":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class App {
    constructor(){
        console.log(`%c${(0, _settingsDefault.default).title} 
Made with \u{2764}\u{FE0F} by ${(0, _settingsDefault.default).author.name} 
\u{21B3} ${(0, _settingsDefault.default).author.link}`, 'color: #000000');
        this.init();
    }
    core() {
        // Initialize core components
        this.appCore = new (0, _coreDefault.default)();
    }
    init() {
        this.core();
    }
...
},{"./settings":"dXtqq","./core":"2de3S","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dXtqq":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = {
    title: "Marissa + Salvador",
    author: {
        name: "SALVADOR \u2014 JUSAINO",
        link: "https://www.instagram.com/salvadorjusaino"
    },
    header: null,
    body: document.body,
    ...
    intro: document.querySelector("#intro_"),
...
},{}],"2de3S":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _settings = require("./settings");
var _settingsDefault = parcelHelpers.interopDefault(_settings);
...
var _simplycountdownJs = require("simplycountdown.js");
var _simplycountdownJsDefault = parcelHelpers.interopDefault(_simplycountdownJs);
var _loader = require("./loader");
class Core {
    constructor(){
        (0, _gsap.gsap).registerPlugin((0, _scrollTrigger.ScrollTrigger));
        /* Scroll to the top every time I refresh the page */ (0, _scrollTrigger.ScrollTrigger).clearScrollMemory("manual");
        this.lenis = null;
        this.ready = false;
        // Settings
        this.settings = (0, _settingsDefault.default);
        // Initialize custom cursor
        this.scroll = new (0, _scroll.Scroll)();
        // Initialize custom cursor
        this.cursor = new (0, _cursor.Cursor)();
        // Initialize custom Loader
        this.loader = new (0, _loader.Loader)();
        this.init();
        this.countdown();
    }
    init() {
        ...
        this.scroll.gotoIntro().then((response)=>{
            (0, _settingsDefault.default).body.classList.remove('loading');
    ...
    countdown() {
        ...
        (0, _simplycountdownJsDefault.default)(myElement, {
            year: 2025,
            month: 10,
            day: 25,
            hours: 0,
            ...
            seconds: 0,
            countUp: false,
            sectionClass: "countdown__block",
            amountClass: "countdown__value",
...
},{"./settings":"dXtqq","./utils":"72Dku","./scroll":"55W1t","./cursor":"3v1v0","gsap":"fPSuC","gsap/ScrollTrigger":"7wnFk","simplycountdown.js":"dzu2f","./loader":"aAovl","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"72Dku":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "preloadImages", ()=>preloadImages);
parcelHelpers.export(exports, "shuffleArray", ()=>shuffleArray);
parcelHelpers.export(exports, "goTop", ()=>goTop);
...
},{}],"55W1t":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Scroll {
    ...
    setup() {
        ...
        this.lenis = new (0, _lenisDefault.default)({
            smooth: true,
            infinite: true,
            autoRaf: !0,
            lerp: 1,
        ...
        this.lenis.on('scroll', ()=>(0, _scrollTrigger.ScrollTrigger).update());
        requestAnimationFrame(raf);
    }
    on() {
        this.lenis.start();
    ...
    async gotoIntro() {
        ...
        tl.to(window, {
            scrollTo: {
                y: (0, _settingsDefault.default).intro,
                offsetY: -1
            },
            duration: 1,
            delay: 0,
...
},{"lenis":"JS2ak","gsap":"fPSuC","gsap/ScrollTrigger":"7wnFk","./settings":"dXtqq","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"JS2ak":[function(require,module,exports,__globalThis) {
// package.json
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3v1v0":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
 ...
 */ class Cursor {
     ...
     */ constructor(Dom_elems, triggerSelector = 'a'){
        ...
        this.DOM.elements = (0, _settingsDefault.default).cursor;
        this.DOM.triggerSelector = triggerSelector;
    }
    on() {
        // Initialize all CursorElement instances
        [
            ...this.DOM.elements
        ].forEach((el)=>this.cursorElements.push(new CursorElement(el)));
        [
            ...document.querySelectorAll(this.DOM.triggerSelector)
        ].forEach((link)=>{
...
},{"./settings":"dXtqq","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dzu2f":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function $(n, e, o) {
    n.forEach((t, l)=>{
        t.word === "seconds" || S(t, n.slice(0, l), e) ? (b(o[t.word], e.zeroPad ? String(t.value).padStart(2, "0") : t.value, e.words[t.word].lambda(e.words[t.word].root, t.value)), o[t.word].style.display = "") : o[t.word].style.display = "none";
    });
}
const y = (n, e)=>{
    let o = {
    ...
    const d = e.inline ? null : E(n, {
        ...
        const s = e.enableUtc ? new Date(Date.UTC(/* @__PURE__ */ new Date().getUTCFullYear(), /* @__PURE__ */ new Date().getUTCMonth(), /* @__PURE__ */ new Date().getUTCDate(), /* @__PURE__ */ new Date().getUTCHours(), /* @__PURE__ */ new Date().getUTCMinutes(), /* @__PURE__ */ new Date().getUTCSeconds())) : /* @__PURE__ */ new Date();
        ...
        const f = Math.floor(i / 86400000);
        i -= f * 86400000;
        const C = Math.floor(i / 3600000);
        i -= C * 3600000;
        const v = Math.floor(i / 60000);
        i -= v * 60000;
    ...
    return n.parentNode && h.observe(n.parentNode, {
        childList: !0
    }), {
        stopCountdown: a,
        resumeCountdown: r,
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aAovl":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Loader {
    constructor(){
        this.promises = [];
        this.loaded = false;
        (0, _gsap.gsap).registerPlugin((0, _scrollTrigger.ScrollTrigger), (0, _scrollToPlugin.ScrollToPlugin), (0, _customEase.CustomEase));
        this.setup();
    }
    setup() {
        const tl = (0, _gsap.gsap).timeline({
        ...
        tl.fromTo(".loader_pane", {
            ...
            delay: .5,
            duration: 1.2,
            ease: (0, _customEase.CustomEase).create("cubic-bezier", ".29,.23,.02,.99"),
            onComplete: ()=>{
                (0, _gsap.gsap).set((0, _settingsDefault.default).loader, {
                    display: "none"
                });
                (0, _gsap.gsap).fromTo((0, _settingsDefault.default).main, {
                    opacity: 0
                }, {
                    duration: 1,
                    ease: (0, _customEase.CustomEase).create("cubic-bezier", ".29,.23,.02,.99"),
...
},{"gsap":"fPSuC","gsap/ScrollTrigger":"7wnFk","gsap/ScrollToPlugin":"9xJDW","gsap/CustomEase":"1y1UF","./settings":"dXtqq","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9xJDW":[function(require,module,exports,__globalThis) {
/*!
